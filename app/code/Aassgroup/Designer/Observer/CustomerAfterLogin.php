...
class CustomerAfterLogin implements ObserverInterface {
    ...
    public function execute(Observer $observer) {
        ...
        $oldQuoteId = $this->_registry->registry(\Aassgroup\Designer\Observer\QuoteMergeBefore::OLD_QUOTE);
        if(!$oldQuoteId) {
            return;
        }
        ...
        $this->_registry->unregister(\Aassgroup\Designer\Observer\QuoteMergeBefore::OLD_QUOTE);
    }
