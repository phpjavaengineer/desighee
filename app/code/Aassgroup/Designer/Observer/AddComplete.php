...
class AddComplete implements ObserverInterface {
    ...
    public function __construct(
        ...
        \Aassgroup\Designer\Model\CartitemFactory $cartItem,
    ...
    protected function getLastQuoteItem(){
      ...
      $productDesigns = $this->_registry->registry(\Aassgroup\Designer\Observer\AddAfter::CURRENT_REGISTRATED_PRODUCT_DESIGNS);
