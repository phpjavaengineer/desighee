...
namespace Aassgroup\Designer\Controller;
...
class Router implements \Magento\Framework\App\RouterInterface {
    ...
    public function match(\Magento\Framework\App\RequestInterface $request) {
        ...
        $pid = $request->getParam(\Aassgroup\Designer\Helper\Url::PRODUCT_ID_VAR_NAME);
        if (!$pid) {
            return;
        }
        ...
        $request
                ...
                ->setActionName('view')
                ->setParam(\Aassgroup\Designer\Helper\Url::PRODUCT_ID_VAR_NAME, $pid);
