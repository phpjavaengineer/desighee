...
namespace Aassgroup\Designer\Ui\DataProvider\Product\Form\Modifier;
...
class Designer extends AbstractModifier {
    ...
    public function __construct(
        ...
        \Aassgroup\Designer\Helper\Fonts $designerFonts, 
        \Aassgroup\Designer\Helper\Data $designerHelper,  
        \Aassgroup\Designer\Helper\Library $libraryHelper, 
                    ...
                    'arguments' => [
                        'data' => [
                            'config' => [
                                ...
                                'component' => 'Aassgroup_Designer/js/designer',
                                'provider' => 'product_form.product_form_data_source',
                                'title' => __('Set Default'),
                                'label' => __('Default'),
                                'saveUrl' => $this->urlBuilder->getUrl('dd_productdesigner/save'),
                                'cssUrl' => $this->_assetRepo->getUrl("Aassgroup_Designer::css/dd_productdesigner.css"),
